...
describe('Component Tests', () => {
  describe('MembershipCategory Management Component', () => {
    let comp: MembershipCategoryComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(MembershipCategoryComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.membershipCategories?.[0]).toEqual(expect.objectContaining({ id: 123 }));
    });
