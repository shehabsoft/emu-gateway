...
describe('Component Tests', () => {
  describe('MembershipType Management Component', () => {
    let comp: MembershipTypeComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(MembershipTypeComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.membershipTypes?.[0]).toEqual(expect.objectContaining({ id: 123 }));
    });
