...
export class MembershipStatusComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.membershipStatusService
      ...
      .subscribe(
        (res: HttpResponse<IMembershipStatus[]>) => {
  ...
  trackId(index: number, item: IMembershipStatus): number {
    return item.id!;
  }

  delete(membershipStatus: IMembershipStatus): void {
    const modalRef = this.modalService.open(MembershipStatusDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
    modalRef.componentInstance.membershipStatus = membershipStatus;
  ...
  protected onSuccess(data: IMembershipStatus[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
