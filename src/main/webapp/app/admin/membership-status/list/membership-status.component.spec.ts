...
describe('Component Tests', () => {
  describe('MembershipStatus Management Component', () => {
    let comp: MembershipStatusComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(MembershipStatusComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.membershipStatuses?.[0]).toEqual(expect.objectContaining({ id: 123 }));
    });
